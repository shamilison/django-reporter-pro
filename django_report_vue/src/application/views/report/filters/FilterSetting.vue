        ...
        data() {
            return {
                ...
                dimensionFilterOptions: [
                    ...
                    {value: 'startswith', text: 'start with (case sensitive)', input: 1,},
                    {value: 'istartswith', text: 'start with (case insensitive)', input: 1,},
                    {value: 'endswith', text: 'end with (case sensitive)', input: 1,},
                    {value: 'iendswith', text: 'end with (case insensitive)', input: 1,},
					...
					{value: 'regex', text: 'matches regex (case sensitive)', input: 1,},
					{value: 'iregex', text: 'matches regex (case insensitive)', input: 1,},
                ...
                measureFilterOptions: [
                    ...
                    {value: 'bi', text: 'between and including', input: 2,},
